...
export default {
  ...
  PROJECT_CREATE_FROM_TEMPLATE: `${PREFIX}/PROJECT_CREATE_FROM_TEMPLATE`,
  PROJECT_CREATE_HANDLE: `${PREFIX}/PROJECT_CREATE_HANDLE`,
  PROJECT_UPDATE: `${PREFIX}/PROJECT_UPDATE`,
  PROJECT_DUPLICATE: `${PREFIX}/PROJECT_DUPLICATE`,
  CURRENT_PROJECT_UPDATE: `${PREFIX}/CURRENT_PROJECT_UPDATE`,
  PROJECT_UPDATE_HANDLE: `${PREFIX}/PROJECT_UPDATE_HANDLE`,
  PROJECT_DUPLICATE_HANDLE: `${PREFIX}/PROJECT_DUPLICATE_HANDLE`,
  PROJECT_CREATE_FROM_TEMPLATE_HANDLE: `${PREFIX}/PROJECT_CREATE_FROM_TEMPLATE_HANDLE`,
